...
#  print HTMLFILE "<p>\n";
  ...
  if (!open(TOPFILE, "/afs/slac/g/lcls/epics/setup/moduleWebPageTop.html"))
     {
     print "WARNING: moduleWebPageTop.html file was not found\n";
     print HTMLFILE "<title>ACCTEST EPICS Software Modules</title>\n";
     print HTMLFILE "<h2><font color=blue>ACCTEST EPICS Software Modules</font></h2>\n";
     print HTMLFILE "</head>\n";
     print HTMLFILE "<body>\n";
     print HTMLFILE "<p>\n";
     }
