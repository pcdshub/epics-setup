# ==================================================
# 
# Name:  go_epics_3.14.12.4-1.2.bash
#
# Rem   Reset the epics environment to use
#       EPICS R3.14.12.4-1.2
#
# Usage: source <path>/go_eics-3.14.12.4-1.2.bash
# -------------------------------------------------
# Mod: 
#     23-Aug-2016,  B. Hill   (bhill)
#        Used go_epics_3-14-12-4_1-1.bash as starting point.
#        base R3.14.12.4-1.2 introduces os specific target
#        architectures such as rhel6-x86_64 and moves
#        to a new version numbering scheme designed for
...
export EPICS_VER=R3.14.12.4-1.2
