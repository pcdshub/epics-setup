...
# Add global broadcast as some DEV hosts configure ip b/c to 255.255.255.255
...
export EPICS_CA_ADDR_LIST=134.79.219.255
# Don't appear to need global broadcast for CA
#export EPICS_CA_ADDR_LIST="${EPICS_CA_ADDR_LIST} 255.255.255.255"
# Add B130-PUB1-CTRLDEV
export EPICS_CA_ADDR_LIST="${EPICS_CA_ADDR_LIST} 172.26.97.63"
