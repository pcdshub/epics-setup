...
sub usage()
{
        print "===================================================================\n";
	print "Usage:\n";
        print "moduleCheckouter.pl Parameter1\n";
        print "\n";
        print "   Parameter1 = file containing list of modules to checkout with list of cvs\n";
        ...
        print "   moduleCheckouter.pl ModulesList.txt\n";
        print "=====================================================================\n";
...
#   1. filename of modules list to cvs checkout of this format:
...
print ">>>CVS checking out modules listed in $moduleListFileName\n";
print ">>>CVSROOT is $ENV{CVSROOT}\n";
print ">>>CVS_RSH is $ENV{CVS_RSH}\n";
print ">>>checking out into directory $epicsModulesTop\n";
print ">>>\n";
...
#my $checkoutCmd = "cvs checkout -r";
my $checkoutCmd = "cvs checkout ";
moduleCVS::doCVSOperation($checkoutCmd, $epicsModulesTop, $moduleListFileName);

chdir $startDir;

print ">>>FINISHED with moduleCheckouter\n";
